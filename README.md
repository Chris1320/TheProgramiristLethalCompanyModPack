...
| v8.1                | v68                              | 2024-11-10    | [MEGA](https://mega.nz/file/Qi4RTKxZ#hoGvOwvnhRagqwuCYtVN2DyAaWLktTond2MhI08fL6A)                                                                                              |
| v8.0                | v68                              | 2024-11-10    | [MEGA](https://mega.nz/file/d6ZyHaxL#XwMJy-2YC4QPX0sbFPZbiVLrAZ9yHeKRrgT1c7-MYZI)                                                                                              |
| v7.1                | v68                              | 2024-11-09    | [MEGA](https://mega.nz/file/BipGUYyA#lbiJYucoNxaagYJM42HbE_ENZZz1IWVyNTCBghlwLJg)                                                                                              |
| v7.0                | v68                              | 2024-11-09    | [MEGA](https://mega.nz/file/o7oGTDRJ#DeXNxshuom19WW74YEfF2P4XaVE3TXFN94WaIkyKpDc)                                                                                              |
| v6.0                | v50                              | 2024-08-24    | [MEGA](https://mega.nz/file/82YD1DSL#vHzxFr8JUCFwQv2bn8GTQ95fVGvfpiS7M8p_XIWJ8g8)                                                                                              |
| v5.5                | v45                              | 2024-05-11    | [MEGA](https://mega.nz/file/hzZlyJRQ#gh54qfsn-nfCNRPnXZw6yT4T0xMOf0vDzsPC5q8_mgA)                                                                                              |
...
<details>
  ...
  <ul>
    <li>Re-enable nameplates</li>
    <li>Lower volume of PizzaTowerEscapeMusic</li>
    <li>Added StarlancerAIFix</li>
    <li>Added StarlancerMoons</li>
    <li>Added WesleysInteriors</li>
    <li>Added WesleysInteriorsAddon</li>
    <li>Added Wesleys Skins</li>
    <li>Removed LethalInternship</li>
    <li>Removed SmartItemSaving</li>
    <li>Added mod dependency JLL</li>
  </ul>
</details>
<details>
  <summary>Changes in v8.4</summary>
  <ul>
    <li>Added Dantors Mental Hospital</li>
    <li>Added FadingFlashlights</li>
    <li>Added LethalCasino</li>
    <li>Added Lethal Foundation Suits</li>
    <li>Added Malfunctions</li>
    <li>Added PsychSanctum</li>
    <li>Added SmartItemSaving</li>
    <li>Removed DimmingFlashlights</li>
    <li>Removed GamblingMachineAtTheCompany</li>
    <li>Removed SCP Foundation Suit</li>
  </ul>
</details>
<details>
  <summary>Changes in v8.3</summary>
  <ul>
    <li>Allow max of one intern only</li>
    <li>Increase time multiplier from 0.8 to 0.9 (slightly faster than before, slightly longer than vanilla)</li>
    <li>Added DramaMask</li>
    <li>Added Fashion Company</li>
    <li>Added LETHALRESONANCE</li>
    <li>Added LETHAL RESONANCE MELTDOWN</li>
    <li>Added Monster Plushies</li>
    <li>Added Motion Tracker V2</li>
    <li>Added PintoBoy</li>
    <li>Added PizzaTowerEscapeMusic</li>
    <li>Added Scavenger Plushie</li>
    <li>Added TerminalFormatter</li>
    <li>Removed DetailedScan</li>
    <li>Added mod dependency EnemySoundFixes</li>
    <li>Added mod dependency loaforcsSoundAPI</li>
    <li>Added mod dependency MrovLib</li>
    <li>Added mod dependency UniTask</li>
    <li>Removed unused dependency TerminalApi</li>
  </ul>
</details>
<details>
  <summary>Changes in v8.2</summary>
  <ul>
    <li>Added BepInEx Faster Load AssetBundles Patcher</li>
    <li>Added BetterEXP</li>
    <li>Added CozyImprovements</li>
    <li>Added CullFactory</li>
    <li>Added DetailedScan</li>
    <li>Added DimmingFlashlights</li>
    <li>Added HideChat</li>
    <li>Added LethalPerformance</li>
    <li>Added NameplateTweaks</li>
    <li>Added PathfindingLagFix</li>
    <li>Added scanForItemsFix</li>
    <li>Added SpikeTrapFixes</li>
    <li>Added mod dependency HarmonyXTranspilerFix</li>
    <li>Added mod dependency TerminalApi</li>
</details>
<details>
  <summary>Changes in v8.1</summary>
  <ul>
    <li>Replaced HookGenPatcher with AutoHookGenPatcher</li>
    <li>Removed BarchLib</li>
    <li>Added mod dependency DetourContext Dispose Fix</li>
    <li>Added mod dependency LethalSettings</li>
    <li>Added mod dependency MirageCore</li>
    <li>Added mod dependency NAudio</li>
    <li>Added mod dependency NAudioLame</li>
  </ul>
</details>
<details>
  <summary>Changes in v8.0</summary>
  <ul>
    <li>Added Atlas Abyss</li>
    <li>Added Celest</li>
    <li>Added CozyOffice</li>
    <li>Added ImmersiveScrap</li>
    <li>Added Outpost 31</li>
    <li>Added SCPFoundationDungeon</li>
    <li>Added Scrap Insurance</li>
    <li>Added SecretLabs</li>
    <li>Re-added LethalLevelLoader</li>
    <li>Removed SaveOurLoot</li>
    <li>Set day length to x0.8 of vanilla settings (longer time per day)</li>
    <li>Added mod dependency LethalModDataLib</li>
  </ul>
</details>
<details>
  <summary>Changes in v7.1</summary>
  <ul>
    <li>Adjusted SaveOurLoot configuration to be less forgiving</li>
  </ul>
</details>
<details>
  <summary>Changes in v7.0</summary>
  <ul>
    <li>Updated AsyncLoggers to 2.1.2</li>
    <li>Updated LethalNetworkAPI to 3.3.1</li>
    <li>Updated LobbyCompatibility to 1.3.0</li>
    <li>Updated MoreCompany to 1.11.0</li>
    <li>Updated Coroner to 2.2.0</li>
    <li>Updated Hold Scan Button to 1.1.2</li>
    <li>Updated More Suits to 1.4.5</li>
    <li>Updated TooManyEmotes to 2.2.11</li>
    <li>Updated EnhancedRadarBooster to 1.7.1</li>
    <li>Updated FacilityMeltdown to 2.6.20</li>
    <li>Updated MoreMoneyStart to 3.0.1</li>
    <li>Updated Mirage to 1.11.1</li>
    <li>Replaced <a href="https://thunderstore.io/c/lethal-company/p/veri/ShipWindows/">Veri's ShipWindows</a> mod with <a href="https://thunderstore.io/c/lethal-company/p/TestAccount666/ShipWindows/">TestAccount666's continuation</a></li>
    <li>Replaced More Emotes with BetterEmotes</li>
    <li>Added Celestial Tint</li>
    <li>Added Cruiser Additions</li>
    <li>Added EnhancedLockpicker</li>
    <li>Added FairAI</li>
    <li>Added GamblingMachineAtTheCompany</li>
    <li>Added LethalInternship</li>
    <li>Added Loadstone</li>
    <li>Added Locker</li>
    <li>Added Longer Day</li>
    <li>Added Remnants</li>
    <li>Added SaveOurLoot</li>
    <li>Added Scopophobia</li>
    <li>Added SCP Foundation Suit</li>
    <li>Added SnatchinBracken</li>
    <li>Added BetterEmotes dependency LethalCompany InputUtils</li>
    <li>Added Coroner dependency StaticNetcodeLib</li>
  </ul>
</details>
<details>
  <summary>Changes in v6.0</summary>
  <ul>
    <li>Updated AsyncLoggers to 1.6.3</li>
    <li>Updated BarchLib to 1.0.2</li>
    <li>Updated BepInEx to 5.4.23.2</li>
    <li>Updated CSync to 5.0.1</li>
    <li>Updated LateCompany to 1.0.17</li>
    <li>Updated LethalLib to 0.16.1</li>
    <li>Updated LethalNetworkAPI to 3.2.0</li>
    <li>Updated LobbyCompatibility to 1.2.0</li>
    <li>Updated MoreCompany to 1.10.1</li>
    <li>Updated Coroner to 2.0.0</li>
    <li>Updated EladsHUD to 1.3.0</li>
    <li>Updated LethalRichPresence to 0.5.9</li>
    <li>Updated LCMaxSoundsFix to 1.2.0</li>
    <li>Updated SuitSaver to 1.2.1</li>
    <li>Updated TooManyEmotes to 2.2.2</li>
    <li>Updated BuyableShotgun to 1.3.0</li>
    <li>Updated BuyableShotgunShells to 1.3.0</li>
    <li>Updated EnhancedRadarBooster to 1.7.1</li>
    <li>Updated FacilityMeltdown to 2.6.18</li>
    <li>Updated HandheldMap to 1.6.2</li>
    <li>Updated LethalSnap to 1.5.7</li>
    <li>Updated Mimics to 2.6.4</li>
    <li>Updated Mirage to 1.8.1</li>
  </ul>
</details>
<details>
  <summary>Changes in v5.5</summary>
  <ul>
    <li>Updated MoreCompany to 1.9.1</li>
    <li>Updated Mirage to 1.7.0</li>
    <li>Migrated from FacilityMeltdownExperimental to FacilityMeltdown</li>
    <li>Increased loot value to 0.2</li>
    <li>Decreased person multiplier and quota multiplier to 25</li>
  </ul>
</details>
...
| [LC Masked Fix](https://thunderstore.io/c/lethal-company/p/kuba6000/LC_Masked_Fix/)                                     | 0.0.2   | Fix vanilla masked bugs                        | Not needed anymore                  |
